...
--
-- Host: localhost
-- Generation Time: Oct 07, 2018 at 02:32 PM
...
INSERT INTO `sekoliko_user` (`id`, `sekoliko_role_id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `usr_firstname`, `usr_lastname`, `usr_address`, `usr_date_create`, `usr_date_update`, `usr_phone`, `usr_photo`, `usr_raison_sociale`, `usr_color`) VALUES
(10, 5, 'julien@techzara.mg', 'julien@techzara.mg', 'julien@techzara.mg', 'julien@techzara.mg', 1, NULL, '$2y$13$ttG0zf1MEFOgYkaBVwspGubh.29yqoD587M2NK/n.zW/4bONwM.Hm', '2018-10-07 14:31:49', NULL, NULL, 'a:1:{i:0;s:14:\"ROLE_PERSONNEL\";}', 'Jul', 'RAJERISON', 'Test', '2018-09-10 16:03:40', '2018-10-07 12:24:43', '0345987215', NULL, NULL, '#FF00FF'),
(15, NULL, 'jul@jul.fr', 'jul@jul.fr', 'jul@jul.fr', 'jul@jul.fr', 1, NULL, '$2y$13$R1.Jpa1Dk3.7tgc527XViOrynCY28AYqIkHHaQLtsztCaZemcrXnC', NULL, NULL, NULL, 'a:0:{}', 'qqqqwqw', 'qqwq', 'qwq', '2018-10-07 07:19:57', '2018-10-07 07:37:43', '0329473033', NULL, NULL, '#FFFFFF'),
(16, NULL, 'julien123@livenexx.fr', 'julien123@livenexx.fr', 'julien@julien.fr', 'julien@julien.fr', 1, NULL, '$2y$13$9rgRq3g.12OsagSwnpxf..oX4iOBpDrozmWaqR5cNQSCkCDBEcDEG', '2018-10-07 13:11:21', NULL, NULL, 'a:0:{}', 'Julien', 'Julien', 'julien', '2018-10-07 07:43:33', '2018-10-07 12:48:10', '0329473033', NULL, NULL, '#FFFFFF');
...
ALTER TABLE `sekoliko_user`
  ...
  ADD KEY `IDX_FD4DE842FAF82993` (`sekoliko_role_id`);
